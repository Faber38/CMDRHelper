...
- Interface plus réactive pendant les traitements de données prolongés.
- Meilleure prise en compte des journaux nouveaux ou complétés après l’importation.
- Traitement des archives et actualisation du minage plus rapides.
- Cliquez sur le nom du système dans la vue système ouverte de la chronique pour le copier.
- Correction de l’affichage des onglets sous Windows en mode sombre.

## Nouveautés de la version 3.4.5
...
- Traitement des archives et actualisation du minage plus rapides.
- Cliquez sur le nom du système dans la vue système ouverte de la chronique pour le copier.
- Autres améliorations des performances et de la stabilité.
- Correction de l’affichage des onglets sous Windows en mode sombre.
...
- Affichage amélioré des planètes, lunes et systèmes multiples
- Mise à jour sûre avec sauvegarde automatique et annulation en cas d’erreur
- Les journaux Elite restent inchangés
- Autres améliorations de stabilité et d’affichage

La mise à jour corrige d’anciennes relations enregistrées entre étoiles, planètes et lunes. Les journaux sont uniquement lus. Ferme Elite Dangerous et rends les anciens journaux disponibles si possible. La base CMDRHelper est intégralement sauvegardée au préalable ; en cas d’erreur, les changements sont annulés et la sauvegarde est restaurée si nécessaire. Elle est conservée par sécurité. Annuler permet de reporter la mise à jour.
...
- La cartographie est conservée même si le scan correspondant apparaît plus tard dans le journal actuel.
- Votre statut de cartographie, son heure et l’efficacité des sondes sont enregistrés de manière fiable.
- L’import des archives ne remplace plus les valeurs existantes de scan et de cartographie par des zéros incorrects.
- Les corps affectés disposant de données complètes retrouvent des valeurs affichées correctes au chargement ou à l’actualisation.
- Les estimations de cartographie Live incluent désormais les bons bonus ; les fractions de crédit ne sont tronquées qu’à la fin.
- Les facteurs de correction issus des ventes ne modifient plus les valeurs d’exploration normales.
- Des tests de non-régression supplémentaires couvrent la cartographie entre sessions et la conservation des données de cartographie.
...
CMDRHelper est développé par Faber38. Des outils d’IA sont utilisés en
appui au développement, à l’analyse du code, aux tests, aux traductions
et à la création de ressources graphiques. Les résultats sont vérifiés
et testés avant leur publication.

Certaines ressources graphiques utilisées dans l’application ont été
créées à l’aide d’une IA générative.
