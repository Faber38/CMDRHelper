...
class MainWindow(QMainWindow):
    ...
    def __init__(self, state):
        ...
        QApplication.instance().aboutToQuit.connect(self._quick_favorite_hotkey.close)
    ...
    def _ensure_navigation_hud(self):
    ...
    def _quick_favorite_message(self, lines):
        try:
            self._ensure_navigation_hud().show_message(lines)
        except (RuntimeError, OSError, ValueError) as exc:
            logging.getLogger(__name__).warning("Quick favorite overlay unavailable: %s", exc)

    def _save_quick_favorite(self):
        from cmdrhelper.quick_favorite import save_quick_favorite
        return save_quick_favorite(self._ensure_planet_navigation_controller(),
                                   self.favorites_view.store, self._quick_favorite_message,
    ...
    def _configure_quick_favorite_hotkey(self):
        self.quick_favorite_settings.choose()
    ...
    def _settings(self):
        ...
        self.quick_favorite_settings = QuickFavoriteSettings(self._quick_favorite_hotkey)
        layout.addWidget(self.quick_favorite_settings)
