...
- **Windows: implementiert und automatisiert getestet; realer Spieltest noch
  ausstehend.** Die Tests simulieren Win32 unter Linux/Qt offscreen. Sie bestätigen
  API-Verträge und Zustandswechsel, keine praktische Eingabe- oder Darstellungsprüfung
  mit Elite unter Windows.
...
Vor praktischer Windows-Freigabe noch mit Elite prüfen: Windowed/Borderless,
100/125/150/200 % DPI, Monitorwechsel mit gemischter DPI, Verschieben/Resize,
Alt-Tab, Minimieren/Wiederherstellen, Ein-/Ausschalten und vollständiges
Durchreichen von Maus-/Tastatureingaben ohne Fokusverlust.
