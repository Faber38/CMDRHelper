...
class ContextHelpTests(unittest.TestCase):
    ...
    def test_explorer_help_contains_all_detailed_sections(self):
        ...
        for passage in (
            ...
            "12 planetare Abbaustandorte gemeldet wurden",
            "Kupfer – 40 t",
            "nicht mit den Funden anderer Commander vermischt",
            "keine belegte direkte Zuordnung",
            "offizieller Erstanspruch unbestätigt",
            "WasDiscovered=false",
            "WasMapped=false",
            "EDSM-Bekanntheit ist eine separate Information",
            "Angaben historische Beobachtungen",
            "Goldrahmen kennzeichnet eine Kartographieschätzung",
    ...
    def test_chronicle_help_contains_all_detailed_sections(self):
        ...
        for passage in (
            ...
            "Example System / 2 — ABBAU ×12 — Kupfer 40 t",
            "ABBAU ×12 — Helium-3 10 t, Kupfer 40 t",
    ...
    def test_chronicle_help_explains_visit_filtering_and_preserved_totals(self):
        ...
        for passage in (
            ...
            "<b>Kupfer 40 t</b> bedeutet nicht automatisch <b>40 t im ausgewählten Zeitraum</b>",
