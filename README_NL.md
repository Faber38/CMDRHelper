...
- Live geregistreerde gevechtsobligaties blijven per commandant bewaard na een herstart; gecontroleerde journaalankers voorkomen dubbeltelling.
- Premies, gevechtsobligaties en Odyssey delen het lezen van het live journaal met afzonderlijke bevestigingen.
- Een eenduidige inwisseling wist het waargenomen saldo van de genoemde factie; oude tegoeden en het ingewisselde bedrag beïnvloeden andere facties niet.
- Overlijden verwijdert waargenomen niet-ingewisselde gevechtsobligaties; wederopstanding en SRV-verlies veroorzaken geen extra reset.
- Premies en gevechtsobligaties blijven gescheiden. Registratiehiaten en opslagfouten worden zichtbaar gemeld.
...
- Stationsafbeeldingen, een afbeeldingsviewer en details over bekende diensten, landingsplatforms, bronnen en tijdstippen.
- Optionele Spansh-stationsinformatie via Instellingen → Online diensten, standaard uitgeschakeld. Na een geslaagde aanvraag worden verdere handmatige aanvragen op dezelfde lokale dag geblokkeerd. Zonder Spansh vermeldt het tabblad de beperkingen van logboekgegevens.
- Persoonlijke scheeps- en carrierafbeeldingen, type-/standaardafbeeldingen en een viewer. Verwijder schepen uit de vloot of herstel ze door alle schepen opnieuw in te lezen; verkochte schepen worden betrouwbaarder herkend.
- Verbeterde kaart, waardelijst met gekleurde karteringsstatus, Cargo HUD en navigatie. Minder achtergrondbelasting onder Linux en bij screenshots, galerij en Explorer.
- Opgelost: onschuldige korte Elite-logboeken onderbreken de mijnbouwvoorraden van de carrier niet meer. Onbekende of onzekere gegevens blijven herkenbaar.
...
- Verbeterde weergave van planeten, manen en meervoudige systemen
- Veilige database-update met automatische reservekopie en terugdraaien bij fouten
- Elite-journaalbestanden blijven ongewijzigd
- Verdere verbeteringen in stabiliteit en weergave

De database-update corrigeert oude opgeslagen relaties tussen sterren, planeten en manen. Journalen worden uitsluitend gelezen. Sluit Elite Dangerous eerst af en stel waar mogelijk historische journalen beschikbaar. Er wordt vooraf een volledige reservekopie van de CMDRHelper-database gemaakt; bij fouten worden wijzigingen teruggedraaid en wordt zo nodig de reservekopie hersteld. Deze blijft bewaard voor de veiligheid. Met Annuleren kun je de update uitstellen.
