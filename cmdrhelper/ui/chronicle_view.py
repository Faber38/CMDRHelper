...
class ChronicleMapWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Feste Darstellungsrotation um 180° um die X-Achse.
        # Dadurch zeigt Z+ in der Chronik-Karte nach oben.
        # Die gespeicherten Elite-StarPos-Koordinaten bleiben unverändert.
        self._display_pitch_offset = math.pi
