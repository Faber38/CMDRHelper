...
HELP_TOPICS["trade"] = ('Kauppa', '<h2>Kauppa</h2><h3>Myy</h3><p>Etsi ja valitse kauppatavara, aseta määrä ja suodattimet ja käynnistä myyntihaku. Vertailukohta on komentajan nykyinen järjestelmä. Hinta / t on myyntihinta; mahdollinen tuotto lasketaan annetulle määrälle, jos kysyntä riittää. Markkinatiedot voivat muuttua. Haku on rajattu; muita tuloksia varten tarvitaan tiukemmat suodattimet. Peruutus voi odottaa käynnissä olevaa verkkovastausta. Hinnat säilyvät vain muistissa. Ostaminen, suositukset, Rare Goods ja reittitoiminnot tulevat myöhemmin.</p>')
