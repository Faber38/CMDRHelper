...
<h3>Odyssey</h3>
<p>”Varastettu” merkitsee varastopinoa, jonka tallennetut Elite-tiedot ilmoittavat nimenomaisesti varastetuksi. Puuttuva tieto ei vahvista, ettei pino olisi varastettu. Tunnettu omistajatunnus näkyy työkaluvihjeessä nimellä ”Omistaja”; tuntematonta omistajan nimeä ei täydennetä.</p>
<p>Työkaluvihje ”Nykyistä saatavuutta ei ole vahvistettu” tarkoittaa kyseisten erikoismateriaalien vahvistamatonta hankintalähdettä. CMDRHelper ei pysty antamaan vahvistettua ajantasaista hankintatietoa; tämä ei tarkoita, ettei esinettä voisi hankkia.</p>

<p>Materiaalit-osion neljäs välilehti sisältää alaluokat Tavarat, Materiaalit, Data ja Kulutustarvikkeet. Kaappi ja reppu näyttävät henkilökohtaiset varastot. Tukialus ✎ näyttää oman tukialuksen käsin vahvistetut yksityiset tavara-, komponentti- ja datamäärät. Kaksoisnapsauta vahvistaaksesi, korjataksesi tai asettaaksesi tuntemattomaksi. — tarkoittaa tuntematonta; 0 on vahvistettava erikseen. « Yhteensä » sisältää kaapin, repun ja tukialuksen vain, kun arvot ovat tunnettuja ja yhtenäisiä. Usean pinon tapauksessa tukialuksen varasto näkyy kerran yhteenvetorivillä; pinot säilyvät erillisinä. Kulutustarvikkeiden yhteismäärä sisältää vain henkilökohtaiset varastot. FCMaterials ei ole täydellinen tukialuksen varasto eikä sitä käytetä sellaisena. Kaapin 1000 esineen raja koskee kutakin luokkaa, ei yksittäistä tavaraa. Tukialuksen varasto lasketaan viimeksi vahvistetusta määrästä. Kaapin muutokset vastakirjataan vain omalla tukialuksella, kun nimenomaiset henkilökohtaiset kaupat on vähennetty. Baarimikon ostot ja myynnit, etenkin muiden pelaajien tekemät, voivat muuttaa todellista varastoa ilman automaattista kirjausta. Vahvista tarvittaessa uudelleen kaksoisnapsautuksella. Yhteismäärä käyttää viimeksi vahvistettuun varastoon perustuvaa arviota, ei taattua reaaliaikaista hakua. Yksityinen Odyssey-tukialusvarasto jakaa 1 000 paikkaa tavaroiden, materiaalien ja datan kesken. Varastosumma tunnetaan kokonaan vasta, kun kaikki nimikkeet ja lisämateriaalit vahvistetaan, myös nollat. Muuten näytetään vähimmäismäärä. Rajan ylittyessä syötteet säilyvät ja Yhteensä muuttuu tuntemattomaksi. Kaappi, reppu ja markkinavaraukset eivät ole tukialuksen yksityistä materiaalivarastoa.<br><b>! – Tukialuksen varaston määritys</b><br>Kaksoisnapsauta Tukialus-saraketta ja syötä nykyinen määrä JOKAISELLE nimikkeelle. Vahvista myös KAIKKI tyhjät nimikkeet nimenomaisesti arvolla 0.<br>— = ei vielä vahvistettu / tuntematon<br>0 = nimenomaisesti vahvistettu tyhjä varasto</p>
<p>Baarimikon avoimet ostotarjoukset varaavat varastotilaa. Pelin tilankäyttö voi ylittää materiaalivaraston. Varaukset eivät ole materiaaleja eivätkä kuulu materiaalien yhteismääriin. Ilman riittävän ajantasaisia markkinatietoja tilankäyttö on tuntematon. Muiden pelaajien kaupat voivat muuttaa tilannetta.</p>
...
<p>Henkilökohtainen varasto päivittyy automaattisesti taustalla. Vahvistetut uudet keräykset voidaan korostaa hetkeksi. Komentajaa vaihdettaessa vanhat määrät poistetaan heti näkyvistä. Alavälilehdet, suodattimet sekä sarakkeiden leveydet ja järjestys tallennetaan Odysseylle erikseen.</p>
<h3>Mining</h3>
...
<p><b>Alkuperä</b><br>Surface tarkoittaa planeettojen pinnalla tapahtuvaa louhintaa; Asteroid tarkoittaa asteroidien/renkaiden louhintaa. Joitakin raaka-aineita saa molemmista (Both), ja ne näkyvät kummassakin sopivassa alkuperäsuodattimessa.</p>""",
              ...
              '<p>”Tehtävät →” avaa pääosion ”Tehtävät ja palkkiot”, jossa näkyvät '
              'tunnetut tehtävätavoitteet ja tilatiedot.</p>\n'
              '\n'
              '<h3>Viimeisin tila</h3>\n'
              ...
              '\n'
              '<h3>Viimeksi vieraillut järjestelmät</h3>\n'
...
<p>Pinnalla sijaitsevien paikkojen ”◎ Koordinaatteihin” välittää tallennetun taivaankappaleen, leveysasteen, pituusasteen ja suosikin nimen olemassa olevalle planeettanavigaattorille. Uusi kohde korvaa aiemman. Suosikeilla ei ole omaa navigointilogiikkaa. Navigaattori päättää edelleen itse: vastaavat kelvolliset planetaariset tiedot aktivoivat navigoinnin; muuten se odottaa näitä tietoja.</p>
...
<p>Esitäyttö käyttää aktiivista komentajaa ja hänen alustaan. Toisen komentajan katselu CMDR-näkymässä ei muuta tätä.</p>"""),
 'images': ('Kuvia',
            ...
            '\n'
            '<h3>Tallenna asetukset</h3>\n<p>”Tallenna asetukset” tallentaa lähde- ja kohdekansiot, tulostusmuodon, kirkastuksen ja molemmat valintaruudut. Seuranta asetetaan uudelleen näiden valintojen mukaan; olemassa olevat BMP-tiedostot merkitään tunnetuiksi. Myös galleria päivitetään.</p>\n<p>”Päivitä galleria” lataa gallerian uudelleen olemassa olevista kuvista nykyisen suodattimen mukaan. Se ei käynnistä BMP-muunnosta.</p>\n\n<h3>Automaattinen käsittely</h3>\n'
            '<p>Jos "Muunna uudet BMP-tiedostot automaattisesti" on aktivoitu ja kelvolliset lähde- ja kohdekansiot on '
            ...
            '<p>Oletuksena alkuperäinen BMP-tiedosto säilytetään. Jos "Poista BMP onnistuneen muunnoksen '
            ...
            '<p>Se tulee olemaan alikansiossa <b>UNKNOWN_&#8203;UNKNOWN/</b> jalostettu; tiedostonimi, jota '
            'käytetään myös komentajassa <b>UNKNOWN</b>. Tätä kansiota voi tarkastella suodattimella ”Kaikki '
            'commanderit”, ei Kohdistamaton juurikansio -suodattimen kautta.</p>\n'
            '\n'
            '<h3>Useita komentajia</h3>\n'
...
<p>Tallennetut tiedot näkyvät myös ilman verkkoyhteyttä ja uudelleenkäynnistyksen jälkeen; ne ovat viimeisin tunnettu tilanne. Kuvat, poistaminen ja uudelleenluku koskevat vain CMDRHelperiä. Ne eivät muuta aluksia, tukialuksia tai krediittejä Elite Dangerousissa eivätkä kirjoita lokeja uudelleen.</p>""",
 ...
 'settings': ('Asetukset',
              ...
              'asetuksia hallinnoi tarvittaessa erikseen Frontier ID.</p>\n\n<h3>Pikasuosikki</h3>\n<p>Kohdassa ”Pikasuosikki” voit asettaa yleisen pikanäppäimen toiminnolla ”Määritä pikanäppäin” tai vaihtaa sen toiminnolla ”Vaihda pikanäppäin”. ”Poista pikanäppäin” poistaa määrityksen; aluksi tila on ”Ei määritetty”. Valinta tallennetaan. Rekisteröintiristiriidasta tulee ilmoitus. Näppäin tallentaa kelvollisen nykyisen pintasijainnin komentajakohtaiseksi suosikiksi ilman valintaikkunaa, ei kuvakaappausta. Ilman sopivia sijaintitietoja mitään ei tallenneta.</p>\n'
              '\n'
              '<h3>päiväkirja</h3>\n'
              '<p>Päiväkirjakansio on yksi tärkeimmistä asetuksista. Sen on osoitettava kansioon, '
              'johon Elite Dangerous tallentaa käytetyn Windows- tai '
              'Proton-profiilin <code>Journal*.log</code> -tiedostot.</p>\n'
              '<p>Lokit sisältävät muun muassa:</p>\n'
              '<ul>\n'
              ...
              '<p>Käsin päivitys voi ohittaa 7 päivän tuoreusajan ja samana päivänä epäonnistuneen automaattisen yrityksen. Jos järjestelmä on jo haettu onnistuneesti tänään paikallisen kalenterin mukaan, uutta pyyntöä ei tehdä: ”Spanshin tiedot on jo päivitetty tänään.” Onnistunut haku uusii asemavälimuistin. Virheessä paikalliset ja käyttökelpoiset välimuistitiedot säilyvät ja tilarivi kertoo virheestä. Epäonnistuneen käsin tehdyn yrityksen voi uusia.</p>\n\n<h3>EDSM-kappaletiedot ja välimuisti</h3>\n<p>”Käytä EDSM:ää” ohjaa myös aktiivisen lokikomentajan nykyisen järjestelmän täydentäviä kappaletietoja Explorerissa. ”Tallenna verkkoyhteydet” ja tavallinen lokipäivitys lataavat käyttökelpoisen välimuistin tai kysyvät EDSM:ltä taustalla. Julkinen kappalehaku tarvitsee verkkoyhteyden mutta ei API-avainta; lokin lähettäminen on erillinen toiminto.</p>\n<p>Haetut kappaletiedot tallennetaan paikallisesti järjestelmittäin, ja niitä voidaan käyttää välimuistista enintään 24 tuntia myös uudelleenkäynnistyksen jälkeen. Vanhemmat tiedot johtavat uuteen hakuun sopivan päivityksen yhteydessä. Kun toiminto on pois käytöstä, välimuisti ei täydennä näkymää eikä uusia kappalehakuja aloiteta; välimuistitiedostoja ei poisteta. Paikalliset lokitiedot pysyvät käytettävissä. Hakuvirhe ei luo keksittyjä kappaleita.</p>\n'
              '\n'
              '<h3>EDSM pääsy</h3>\n'
              ...
              '<p>Sivupalkin ”näytä automaattisesti”-kytkimet ovat riippumattomia: ”Arvokkaat kappaleet”, ”BIO-löydöt”, ”GEO” ja ”Rahtitila” ohjaavat omia reaaliaikaisia ikkunoitaan. ”Rahtitilan HUD” näyttää rahdin peittokuvassa, ”Navigointi-HUD” aktiivisen planeettanavigoinnin. Nämä näyttökytkimet eivät itse aloita verkkohakuja; HUD vaatii Eliten etualalle ja sopivat tiedot.</p>\n<p>”EDSM-tila-HUD” tarvitsee sen sijaan oman julkisen EDSM-verkkokyselyn riippumatta ”Käytä EDSM:ää”-valinnasta, kappalevälimuistista ja API-avaimesta. Inara-lähetyksillä ja Spansh-asematiedoilla on omat palvelukytkimensä; HUD-kytkimet eivät ota niitä käyttöön.</p>\n\n<h3>Päivitykset</h3>\n'
