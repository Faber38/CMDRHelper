...
<p>Odyssey-inventarium: den fjärde materialfliken innehåller 223 katalogidentiteter för varor, material, data och förbrukningsvaror. Skeppsförråd, ryggsäck och tillförlitlig totalsumma hålls isär; uppdragsstaplar, uppdragsstatus och engineering-användning visas. Positiva antal visas i guld. Namn utan översättning visas på engelska.</p>
...
<h3>Odyssey</h3>
<p>”Stulet” markerar en lagerstapel som uttryckligen är registrerad som stulen i sparade Elite-data. Saknad markering bekräftar inte att den inte är stulen. En känd ägaridentifierare visas i verktygstipset som ”Ägare”; okända ägarnamn fylls inte i.</p>
<p>Verktygstipset ”Nuvarande tillgänglighet är inte bekräftad” anger en obekräftad anskaffningskälla för berörda specialmaterial. CMDRHelper kan inte ge bekräftad aktuell anskaffningsinformation; det betyder inte att föremålet är omöjligt att få tag på.</p>

<p>Den fjärde fliken under Material innehåller Varor, Material, Data och Förbrukningsvaror. Skåp och ryggsäck visar personliga lager. Hangarfartyg ✎ visar manuellt bekräftat privat lager av varor, material och data på ditt eget hangarfartyg. Dubbelklicka för att bekräfta, korrigera eller ange som okänt. — betyder okänt; 0 måste bekräftas uttryckligen. « Totalt » omfattar skåp, ryggsäck och hangarfartyg endast när värdena är kända och samstämmiga. Vid flera staplar visas hangarfartygets lager en gång i sammanfattningen; staplarna förblir separata. Förbrukningsvaror behåller den personliga totalen utan hangarfartyg. FCMaterials är inte ett fullständigt hangarfartygslager och används inte som ett sådant. Skåpgränsen på 1000 gäller per kategori, inte per föremål. Hangarfartygets lager beräknas från senast bekräftat värde. Skåpändringar motbokas bara på det egna hangarfartyget, efter avdrag för uttryckliga personliga transaktioner. Köp och försäljningar hos bartendern, särskilt av andra spelare, kan ändra det verkliga lagret utan automatisk registrering. Dubbelklicka för att bekräfta igen vid behov. Totalt använder en beräkning från senast bekräftat lager, ingen garanterad direktavläsning. Det privata Odyssey-lagret delar 1 000 platser mellan varor, material och data. Lagersumman är helt känd först när alla positioner och extra material bekräftats, även nollor. Annars visas ett minimum. Vid överskridande behålls värdena och Totalt blir okänt. Skåp, ryggsäck och marknadsreservationer är inte hangarfartygets privata materiallager.<br><b>! – Ställ in hangarfartygets lager</b><br>Dubbelklicka i kolumnen Hangarfartyg och ange aktuell mängd för VARJE position. Bekräfta även ALLA tomma positioner uttryckligen med 0.<br>— = ännu inte bekräftat / okänt<br>0 = uttryckligen bekräftat tomt lager</p>
<p>Öppna köporder hos bartendern reserverar lagerutrymme. Beläggningen i spelet kan därför överstiga materiallagret. Reservationer är inte material och ingår inte i materialsummorna. Utan tillräckligt aktuella marknadsdata är beläggningen okänd. Andra spelares handel kan ändra ögonblicksbilden.</p>
...
<p>Det personliga beståndet uppdateras automatiskt i bakgrunden. Bekräftade nya insamlingar kan markeras kort. Vid byte av commander tas gamla bestånd omedelbart bort. Underflikar, filter, kolumnbredder och kolumnordning sparas separat för Odyssey.</p>
<h3>Mining</h3>
<p>Material → Mining är den centrala översikten över 57 kända handelsbara gruvvaror, åtskilda från engineering-material. En gemensam tabell omfattar både utvinning på planetytor och i asteroider/ringar. Fasta referenspriser är endast vägledande, inte marknadspriser i realtid.</p>
<p><b>Kolumner</b><br><b>Råvara:</b> varans eller råvarans namn.<br><b>SRV:</b> verifierat lager i SRV.<br><b>Skepp:</b> verifierat lager i skeppet.<br><b>Carrier:</b> lager på din egen carrier; Elite levererar ingen fullständig personlig lagerlista, så startlagret måste bekräftas manuellt.<br><b>Totalt:</b> SRV + Skepp + Carrier, endast när alla tre mängder är kända. Annars —; okänt är inte noll.<br><b>Snittpris Cr/t:</b> fast riktvärde utan garanti för aktuellt försäljningspris. Saknade referenspriser förblir okända.<br><b>Värdeklass:</b> HÖG från 100 000 Cr/t; MEDEL vid 25 000–99 999 Cr/t; LÅG under 25 000 Cr/t. Ett okänt pris har ingen värdeklass.</p>
<p><b>Bekräfta carrierlager</b><br>Elite Dangerous ger inte CMDRHelper en fullständig personlig lagerlista för carriern. Så anger du en känd utgångspunkt för en vara: 1. Dubbelklicka på carriercellen. 2. Ange aktuellt lager som ett heltal från 0 och uppåt. 3. Verkställ värdet för att bekräfta det manuellt. 4. CMDRHelper följer sedan automatiskt entydiga CargoTransfer-händelser mellan skeppet och din egen carrier. Verktygstipset visar den manuella bekräftelsen och eventuell senare uppdatering.</p>
<p><b>— = okänt lager</b><br>Utan bekräftat startlager kan enskilda överföringar inte ge ett tillförlitligt absolut carrierlager. Dubbelklicka när som helst för att ändra, korrigera eller återställa värdet till okänt. Om en överföring skulle ge ett motsägelsefullt eller negativt resultat blir lagret okänt igen och måste bekräftas manuellt på nytt.</p>
<p><b>Skepp och SRV</b><br>SRV- och skeppslager återskapas separat från verifierade lastdata. Okända mängder förblir —. Fullständiga lastögonblicksbilder har företräde framför beräknade ändringar.</p>
<p><b>↻ Uppdatera</b><br>SRV-lager och skeppslager uppdateras separat från verifierade data. Bekräftat carrierlager bevaras oberoende av detta. Vanliga liveuppdateringar fortsätter automatiskt. Grönt betyder redo eller lyckat, färganimationen visar pågående uppdatering och rött ett misslyckat försök. Saknade eller ej verifierbara data visas inte som tomt lager.</p>
<p><b>Kombinera filter</b><br>Råvarusökningen filtrerar efter namn. Värdeklass erbjuder Alla, HÖG, MEDEL och LÅG; ursprung erbjuder Alla, Planetär gruvdrift och Asteroider/Ringar. ”Endast i lager” visar en vara om minst ett känt lager i SRV, skepp eller carrier är positivt. Okända lager räknas inte som 0 och döljer inte ett känt positivt lager på en annan plats. Sökning, värdeklass, ursprung och lagerfilter kan kombineras.</p>
<p><b>ABBAU ×N i utforskaren</b><br>Ett klick öppnar Material → Mining och ställer automatiskt ursprungsfiltret på Planetär gruvdrift. Det finns ingen andra Mining-tabell i utforskaren.</p>
<p><b>Sortering och bredder</b><br>Klicka på kolumnrubriker för stigande eller fallande sortering. Lager och priser sorteras numeriskt, med okända värden sist. Dra kolumngränserna med musen för att ändra bredd. Sortering, kolumnbredder och filtren för värdeklass, ursprung och Endast i lager sparas.</p>
<p><b>Ursprung</b><br>Surface betyder utvinning på planetytor; Asteroid betyder gruvdrift i asteroider/ringar. Vissa råvaror finns i båda miljöerna (Both) och visas i båda motsvarande ursprungsfilter.</p>""",
    ),'overview': ('Översikt',
              '<h2>Översikt</h2>\n'
              ...
              '<p>”Uppdrag →” öppnar huvudområdet ”U'
              'ppdrag och belöningar” med kända uppdragsmål och statusinformation.</p>\n'
              '\n'
              '<h3>Senaste status</h3>\n'
              '<p>"Senaste status" sammanfattar det senast kända ihållande befälhavartillståndet. '
              'Detta gör att viktig information kan återställas även efter omstart av Elite '
              'Dangerous eller CMDRHelper.</p>\n'
              '\n'
              '<h3>Senast besökta system</h3>\n'
              '<p>System som nyligen har besökts eller identifierats från journalen visas '
              'här.</p>\n'
...
<p>Den lokala uppdragsvyn behöver ingen Inara-anslutning. Med en aktiverad anslutning som är konfigurerad för den aktiva befälhavaren kan uppdragshändelser som stöds även överföras.</p>""",
 ...
 'explorer': ('Utforskare',
              ...
              '\n'
              '<h3>BIO / GEO / ABBAU</h3>\n'
              '<p>Den här vyn samlar himlakroppar med biologiska, geologiska eller planetära gruvsignaler.</p>\n'
              ...
              '<h3>Använda tabellerna</h3>\n<p>Klicka på en kolumnrubrik i värdelistan eller BIO / GEO / ABBAU '
              'för att sortera; klicka igen för att vända riktningen. Dra kolumngränserna med musen för att '
              'ändra bredden. Sortering och kolumnbredder sparas separat för varje tabell. Himlakroppsnamn '
              'sorteras naturligt, till exempel A 2 före A 10. Avstånd, krediter och antal sorteras numeriskt. '
              'Status, analys och besökt sorteras efter betydelse, inte alfabetiskt.</p>\n\n'
              '<h3>Kroppsdetalj</h3>\n'
...
<h3>Avståndsfilter</h3>
<p>”Avståndsfilter” är avstängt som standard. ”Max. avstånd:” är från början 500 ly och kan ställas in från 1 till 100 000 ly. Avståndet räknas från det aktuellt kända systemet med lokalt tillgängliga systemkoordinater. Ingen nätförfrågan görs enbart för detta filter.</p>
<p>Favoriter med känt avstånd utanför gränsen döljs. Favoriter med okänt avstånd förblir synliga. Om det aktuella systemets koordinater saknas döljer avståndsfiltret inga poster. Sökning samt typ- och kategorifilter gäller fortfarande. Filtreringen uppdateras automatiskt efter ett systembyte. Reglaget och maxavståndet sparas.</p>

<h3>Exportera favoriter</h3>
<p>”Exportera” skapar en portabel ZIP med alla favoriter för den aktiva befälhavaren, inte bara poster som visas genom sökning eller typ-, kategori- och avståndsfilter. favorites.json innehåller strukturerade favoritdata; tillgängliga favoritbilder finns under images/. Paketet kan överföras mellan Linux och Windows.</p>
<p>Befintliga favoriter och originalbilder ändras inte. Bilder med identiskt innehåll sparas bara en gång i paketet. Saknade eller skadade bilder hindrar inte export av favoritdata. Import och export tillåter högst 32 MiB per fil och totalt 256 MiB okomprimerat paketinnehåll.</p>

<h3>Importera favoriter</h3>
<p>”Importera” kontrollerar först ZIP-filen och visar en sammanställning av nya och befintliga favoriter innan något ändras. Importerade favoriter tilldelas den aktuellt aktiva befälhavaren. Dubbletter identifieras efter typ, kategori, namn och plats: kända system-/himlakropps-ID:n och koordinater, annars system-/himlakroppsnamn. Även dubbletter inom paketet räknas med.</p>
<p>Ett gemensamt val gäller alla upptäckta dubbletter: ”Hoppa över” är standard och bevarar befintliga poster; ”Ersätt befintlig favorit” överför importerade data till den befintliga favoriten; ”Importera som ny post” skapar en extra post. Avbryt importerar ingenting.</p>
<p>Ogiltiga favoritdata stoppar hela importen. Vid importfel återställs databasändringarna för att undvika en delvis genomförd import. Saknade eller skadade bilder hindrar inte import av giltiga data; dessa favoriter importeras utan bild. CMDRHelper hanterar importerade bilder lokalt.</p>
...
<p>Favoritbilder kan exporteras och kopieras lokalt vid import. Delade interna bildkopior behålls så länge en annan favorit behöver dem. När en import ersätter favoriter behålls gamla bildfiler tills vidare som en försiktighetsåtgärd.</p>
...
<p>Förvalen använder aktiv befälhavare och skepp. Att bara visa en annan befälhavare i CMDR-vyn ändrar inte detta.</p>"""),
 'images': ('Bilder',
            ...
            '\n'
            '<h3>Spara inställningar</h3>\n<p>”Spara inställningar” sparar käll- och målmapp, utdataformat, uppljusning och båda kryssrutorna. Övervakningen ställs in på nytt med dessa val; befintliga BMP-filer markeras som kända. Galleriet uppdateras också.</p>\n<p>”Uppdatera galleri” laddar om galleriet från befintliga bildfiler för aktuellt filter. Det startar ingen BMP-konvertering.</p>\n\n<h3>Automatisk bearbetning</h3>\n'
            '<p>Om "Konvertera nya BMP-filer automatiskt" är aktiverat och giltiga käll- och målmappar är '
            ...
            '<p>Som standard behålls den ursprungliga BMP-filen. Om "Ta bort BMP efter lyckad '
            ...
            '<p>Det kommer att finnas i undermappen <b>UNKNOWN_&#8203;UNKNOWN/</b> bearbetade; filnamnet '
            'används också för Commander <b>UNKNOWN</b>. Den här mappen kan visas via Alla '
...
<p>Sparade uppgifter kan visas offline och efter omstart; de motsvarar senast kända tillstånd. Bilder, borttagning och ny inläsning gäller bara CMDRHelper. De ändrar inga skepp, hangarfartyg eller krediter i Elite Dangerous och skriver inte om journalerna.</p>""",
 ...
 'settings': ('Inställningar',
              ...
              'inställningar hanteras separat av Frontier ID vid behov.</p>\n\n<h3>Snabbfavorit</h3>\n<p>Under ”Snabbfavorit” väljer du ”Ange snabbtangent” för att ange en global snabbtangent eller ”Ändra snabbtangent” för att ändra den. ”Ta bort snabbtangent” tar bort tilldelningen; ursprungligen gäller ”Inte tilldelad”. Valet sparas. En registreringskonflikt ger ett meddelande. Tangenten sparar en giltig aktuell ytposition som commanderbunden favorit utan dialog, inte en skärmbild. Utan lämpliga positionsdata sparas ingenting.</p>\n'
              '\n'
              '<h3>journal</h3>\n'
              '<p>Journalmappen är en av de viktigaste inställningarna. Den måste peka på mappen '
              'där Elite Dangerous <code>Journal*.log</code> filer för den Windows- eller '
              'Proton-profil som används.</p>\n'
              '<p>Journalerna ger bland annat:</p>\n'
              '<ul>\n'
              ...
              '<p>Journalgruppen visar mappuppsättningen, antalet hittade journaler, äldsta och '
              'senaste journaler, namnet på den senaste filen och tidpunkten för den senast '
              'lästa posten.</p>\n'
              ...
              'tydligt tilldelade journaler.</p>\n'
              '\n'
              ...
              '<p>Manuell uppdatering kan kringgå perioden på 7 dagar och ett misslyckat automatiskt försök samma dag. Om systemet redan hämtats framgångsrikt i dag enligt lokal kalender görs inget nytt anrop: ”Spansh-data har redan uppdaterats idag.” En lyckad hämtning förnyar stationscachen. Vid fel bevaras lokala uppgifter och användbara cachedata, och statusraden visar felet. Ett misslyckat manuellt försök kan upprepas.</p>\n\n<h3>EDSM-kroppsdata och cache</h3>\n<p>”Använd EDSM” styr även kompletterande himlakroppsdata för den aktiva journalcommanderns nuvarande system i Explorer. Efter ”Spara onlineåtkomst” och vid normal journaluppdatering läses en användbar cache eller frågas EDSM i bakgrunden. Den offentliga hämtningen kräver nätverk men ingen API-nyckel; journaluppladdning är en separat åtgärd.</p>\n<p>Hämtade himlakroppsdata lagras lokalt per system och kan användas från cachen i upp till 24 timmar, även efter omstart. Äldre data leder till en ny hämtning vid en lämplig uppdatering. När funktionen är av kompletterar cachen inte visningen och inga nya kroppsförfrågningar startas; cachefilerna raderas inte. Lokala journaldata förblir användbara. Hämtningsfel skapar inga påhittade himlakroppar.</p>\n'
              '\n'
              ...
              '<p>Reglagen under ”visa automatiskt” i sidofältet fungerar oberoende: ”Värdefulla himlakroppar”, ”BIO-fynd”, ”GEO” och ”Lastrum” styr sina respektive livefönster. ”Lastutrymmets HUD” visar last i överlägget, ”Navigations-HUD” aktiv planetnavigering. Dessa visningsreglage startar inte själva nätfrågor; HUD kräver Elite i förgrunden och lämpliga data.</p>\n<p>”EDSM-status-HUD” kräver däremot en egen offentlig EDSM-nätfråga, oberoende av ”Använd EDSM”, kroppscachen och en API-nyckel. Inara-uppladdning och Spansh-stationsinformation har egna tjänstereglage; HUD-reglagen aktiverar dem inte.</p>\n\n<h3>Uppdateringar</h3>\n'
