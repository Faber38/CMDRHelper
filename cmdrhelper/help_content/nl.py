...
<h3>Odyssey</h3>
<p>‘Gestolen’ markeert een voorraadstapel die in de opgeslagen Elite-gegevens uitdrukkelijk als gestolen staat. Een ontbrekende aanduiding bevestigt niet dat de stapel niet gestolen is. Een bekende eigenaarscode verschijnt in de tooltip als ‘Eigenaar’; een onbekende eigenaarsnaam wordt niet aangevuld.</p>
<p>De tooltip ‘Huidige beschikbaarheid niet bevestigd’ wijst bij de betreffende speciale materialen op een onbevestigde verkrijgingsbron. CMDRHelper kan geen bevestigde actuele verkrijgingsinformatie geven; dit betekent niet dat het voorwerp onverkrijgbaar is.</p>

<p>Het vierde tabblad onder Materialen bevat Goederen, Materialen, Data en Verbruiksartikelen. Kluis en rugzak tonen persoonlijke voorraden. Carrier ✎ toont de handmatig bevestigde privévoorraad van goederen, materialen en data op je eigen carrier. Dubbelklik om te bevestigen, corrigeren of op onbekend te zetten. — betekent onbekend; 0 moet uitdrukkelijk worden bevestigd. Totaal omvat kluis, rugzak en carrier alleen als de waarden bekend en samenhangend zijn. Bij meerdere stapels staat de carriervoorraad eenmaal in de overzichtsregel; stapels blijven gescheiden. Verbruiksartikelen behouden het persoonlijke totaal zonder carrier. FCMaterials is geen volledige carriervoorraad en wordt niet als zodanig gebruikt. De kluislimiet van 1000 geldt per categorie, niet per artikel. De carriervoorraad wordt berekend vanaf de laatste bevestiging. Kluiswijzigingen worden alleen op de eigen carrier tegengeboekt, na aftrek van expliciete persoonlijke transacties. Aankopen en verkopen bij de barkeeper, vooral door andere spelers, kunnen de werkelijke voorraad wijzigen zonder automatische registratie. Dubbelklik indien nodig om opnieuw te bevestigen. Totaal gebruikt een projectie van de laatst bevestigde carriervoorraad, geen gegarandeerde live-opvraag. De privéopslag Odyssey deelt 1.000 plaatsen tussen goederen, materialen en data. De voorraadsom is pas volledig bekend als alle posities en aanvullende materialen bevestigd zijn, inclusief nullen. Anders verschijnt een minimum. Bij overschrijding blijven invoeren behouden en wordt Totaal onbekend. Kluis, rugzak en marktreserveringen zijn geen privévoorraad van de carrier.<br><b>! – Carriervoorraad instellen</b><br>Dubbelklik in de kolom Carrier en voer voor ELKE positie de huidige carriervoorraad in. Bevestig ook ALLE lege posities uitdrukkelijk met 0.<br>— = nog niet bevestigd / onbekend<br>0 = uitdrukkelijk bevestigde lege voorraad</p>
<p>Open kooporders bij de bartender reserveren opslagruimte. De bezetting in het spel kan dus hoger zijn dan de materiaalvoorraad. Reserveringen zijn geen materialen en tellen niet mee in materiaaltotalen. Zonder voldoende actuele marktgegevens blijft de bezetting onbekend. Handel van andere spelers kan de momentopname veranderen.</p>
...
<p>De persoonlijke voorraad wordt op de achtergrond automatisch bijgewerkt. Bevestigde nieuwe vondsten kunnen kort worden gemarkeerd. Bij een commanderwissel worden oude voorraden direct verwijderd. Subtabbladen, filters, kolombreedtes en kolomvolgorde worden voor Odyssey afzonderlijk opgeslagen.</p>
<h3>Mining</h3>
...
<p><b>Herkomst</b><br>Surface betekent planetaire oppervlaktewinning; Asteroid betekent mijnbouw in asteroïden/ringen. Sommige grondstoffen komen uit beide omgevingen (Both) en verschijnen in beide passende herkomstfilters.</p>""",
              ...
              '<p>Met ‘Missies →’ open je het hoofdonderdeel ‘Missies en beloningen’ '
              'met de bekende missiedoelen en statusinformatie.</p>\n'
              '\n'
              '<h3>Laatste stand</h3>\n'
              ...
              '<p>Hier worden onlangs bezochte of uit het journaal herkende systemen '
              'weergegeven.</p>\n'
...
<p>De lokale missieweergave heeft geen Inara-verbinding nodig. Met een ingeschakelde verbinding die voor de actieve commander is ingesteld, kunnen ondersteunde missiegebeurtenissen ook worden verzonden.</p>""",
 ...
 'explorer': ('Ontdekkingsreiziger',
              ...
              '<ul>\n'
              '<li>bekende en zelfs opgenomen lichamen in het journaal</li>\n'
              ...
              'van de overeenkomstige journaalgebeurtenissen.</p>\n'
...
<p>De voorgestelde waarden komen van de actieve commander en diens schip. Een andere commander bekijken in de CMDR-weergave verandert dat niet.</p>"""),
 'images': ('Afbeeldingen',
            ...
            '\n'
            '<h3>Instellingen opslaan</h3>\n<p>‘Instellingen opslaan’ bewaart bron- en doelmap, uitvoerformaat, opheldering en beide selectievakjes. De bewaking wordt opnieuw ingesteld; bestaande BMP’s worden als bekend gemarkeerd. Ook de galerij wordt vernieuwd.</p>\n<p>‘Galerij vernieuwen’ laadt de galerij opnieuw uit de bestaande afbeeldingsbestanden voor het huidige filter. Dit start geen BMP-conversie.</p>\n\n<h3>Automatische verwerking</h3>\n'
            '<p>Als “Nieuwe BMP-bestanden automatisch converteren” is geactiveerd en geldige bron- en doelmappen zijn '
            ...
            '<p>Standaard wordt het originele BMP-bestand behouden. Als “BMP na succesvolle conversie '
            ...
            'Commander.</p>\n'
            '<p>Het zal in de submap staan <b>UNKNOWN_&#8203;UNKNOWN/</b> verwerkt; de bestandsnaam die ook '
            'voor de Commander wordt gebruikt <b>UNKNOWN</b>. Deze map kan worden bekeken via Alle '
...
<p>Opgeslagen informatie is ook offline en na een herstart zichtbaar; het is de laatst bekende stand. Afbeeldingen, verwijderen en opnieuw inlezen betreffen alleen CMDRHelper. Ze wijzigen geen schepen, carriers of credits in Elite Dangerous en herschrijven geen journals.</p>""",
 ...
 'settings': ('Instellingen',
              ...
              'Frontier ID.</p>\n\n<h3>Snelle favoriet</h3>\n<p>Bij ‘Snelle favoriet’ stel je met ‘Sneltoets instellen’ een globale sneltoets in of wijzig je die met ‘Sneltoets wijzigen’. ‘Sneltoets verwijderen’ verwijdert de toewijzing; aanvankelijk geldt ‘Niet toegewezen’. De keuze wordt bewaard. Een registratieconflict geeft een melding. De toets bewaart zonder dialoog een geldige huidige oppervlaktepositie als commandergebonden favoriet, geen screenshot. Zonder passende positiegegevens wordt niets opgeslagen.</p>\n'
              '\n'
              '<h3>journaal</h3>\n'
              '<p>De journaalmap is een van de belangrijkste instellingen. Het moet verwijzen naar '
              'de map waarin Elite Dangerous het <code>Journal*.log</code> bestanden van het '
              'gebruikte Windows- of Proton-profiel.</p>\n'
              '<p>De journalen bieden onder meer:</p>\n'
              '<ul>\n'
              ...
              '<p>De dagboekgroep toont de mappenset, het aantal gevonden journalen, de oudste '
              ...
              'elk journaal de volgende keer dat het wordt gestart, onnodig in zijn geheel '
              'wordt herlezen.</p>\n'
              '\n'
              '<h3>database</h3>\n'
              ...
              '\n'
              '<h3>Journaalarchief importeren</h3>\n'
              ...
              'toegewezen journalen opnieuw te leren.</p>\n'
              '\n'
              ...
              '<p>Handmatig vernieuwen kan de periode van 7 dagen en een mislukte automatische poging van die dag omzeilen. Is het systeem vandaag volgens de lokale kalender al succesvol opgehaald, dan volgt geen nieuw verzoek: ‘De Spansh-gegevens zijn vandaag al bijgewerkt.’ Succesvol ophalen vernieuwt de stationcache. Bij fouten blijven lokale en bruikbare cachegegevens behouden en meldt de statusregel de fout. Een mislukte handmatige poging kan opnieuw worden gestart.</p>\n\n<h3>EDSM-hemellichaamgegevens en cache</h3>\n<p>‘EDSM gebruiken’ bestuurt ook aanvullende hemellichaamgegevens voor het huidige systeem van de actieve journaalcommander in Explorer. Na ‘Online toegang opslaan’ en bij normale journaalverversing wordt een bruikbare cache geladen of EDSM op de achtergrond geraadpleegd. Deze openbare opvraag vereist netwerk, maar geen API-sleutel; journaaluploads zijn een afzonderlijke handeling.</p>\n<p>Opgehaalde hemellichaamgegevens worden lokaal per systeem bewaard en maximaal 24 uur uit de cache gebruikt, ook na herstarten. Oudere gegevens leiden bij een geschikte verversing tot een nieuwe opvraag. Bij uitschakeling vult deze cache de weergave niet aan en starten geen nieuwe lichaamsopvragen; cachebestanden worden niet verwijderd. Lokale journaalgegevens blijven bruikbaar. Opvraagfouten leveren geen verzonnen hemellichamen op.</p>\n'
              '\n'
              ...
              '<p>De schakelaars onder ‘automatisch tonen’ in de zijbalk werken onafhankelijk: ‘Waardevolle hemellichamen’, ‘BIO-vondsten’, ‘GEO’ en ‘Vrachtruim’ regelen hun eigen livevensters. ‘Vracht-HUD’ toont vracht in de overlay, ‘Navigatie-HUD’ de actieve planeetnavigatie. Deze weergaveschakelaars starten zelf geen onlineopvraag; HUD’s vereisen Elite op de voorgrond en passende gegevens.</p>\n<p>‘EDSM-status-HUD’ vereist wel een eigen openbare EDSM-netwerkopvraag, onafhankelijk van ‘EDSM gebruiken’, de lichaamscache en een API-sleutel. Inara-uploads en Spansh-stationsinformatie hebben eigen dienstschakelaars; HUD-schakelaars zetten ze niet aan.</p>\n\n<h3>Updates</h3>\n'
              ...
              'journaalarchief ook na de herstart opnieuw geëvalueerd.</p>\n'
              '\n'
              '<h3>Verschillende commandanten</h3>\n'
