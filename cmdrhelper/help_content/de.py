...
HELP_TOPICS["trade"] = ('Handel', '<h2>Handel</h2><h3>Verkaufen</h3><p>Ware suchen und auswählen, Menge und Filter festlegen, dann die Verkaufssuche starten. Ausgangspunkt ist das aktuelle Commander-System. Preis / t ist der Verkaufspreis; der mögliche Erlös gilt für die eingegebene Menge bei ausreichender Nachfrage. Marktdaten können sich ändern. Die Suche ist begrenzt; weitere Treffer erfordern engere Filter. Abbrechen kann auf eine laufende Netzwerkantwort warten. Preise bleiben ausschließlich im Arbeitsspeicher. Einkaufen, Empfehlungen, Rare Goods und Routenübergabe folgen später.</p>')
